...
SWEP.MalfunctionMeanShotsToFail = 710 * 1.5
...
SWEP.ShootSound = { pathfire .. "cgnl_di_outdoor_close_01.wav", pathfire .. "cgnl_di_outdoor_close_02.wav", pathfire .. "cgnl_di_outdoor_close_03.wav" }

SWEP.ShootSoundSilenced = { pathfire .. "cgnl_di_outdoor_silenced_close_01.wav", pathfire .. "cgnl_di_outdoor_silenced_close_02.wav", pathfire .. "cgnl_di_outdoor_silenced_close_03.wav" }

SWEP.ShootSoundIndoor = { pathfire .. "cgnl_di_indoor_close_01.wav", pathfire .. "cgnl_di_indoor_close_02.wav", pathfire .. "cgnl_di_indoor_close_03.wav" }

SWEP.ShootSoundSilencedIndoor = { pathfire .. "cgnl_di_indoor_silenced_close_01.wav", pathfire .. "cgnl_di_indoor_silenced_close_02.wav", pathfire .. "cgnl_di_indoor_silenced_close_03.wav" }

SWEP.DistantShootSound = { pathfire .. "cgnl_di_outdoor_distant_01.wav", pathfire .. "cgnl_di_outdoor_distant_02.wav", pathfire .. "cgnl_di_outdoor_distant_03.wav" }
SWEP.DistantShootSoundSilenced = { pathfire .. "cgnl_di_outdoor_silenced_distant_01.wav", pathfire .. "cgnl_di_outdoor_silenced_distant_02.wav", pathfire .. "cgnl_di_outdoor_silenced_distant_03.wav" }
SWEP.DistantShootSoundIndoor = { pathfire .. "cgnl_di_indoor_distant_01.wav", pathfire .. "cgnl_di_indoor_distant_02.wav", pathfire .. "cgnl_di_indoor_distant_03.wav" }
SWEP.DistantShootSoundSilencedIndoor = { pathfire .. "cgnl_di_indoor_silenced_distant_01.wav", pathfire .. "cgnl_di_indoor_silenced_distant_02.wav", pathfire .. "cgnl_di_indoor_silenced_distant_03.wav" }
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if anim == "inspect" then
        ...
        if rand == 2 then
            ...
            if elements["long545"] then mag = "_long545" end
            rand = rand .. mag
        end
...
SWEP.Animations = {
    ...
    ["reload_empty_60rnd"] = {
        ...
        FireASAP = true,
        MagSwapTime = 1.5,
        EventTable = rst_reloadempty60rnd,
        IKTimeLine = rik_reloadempty
    },
    ["1_reload_empty_60rnd"] = {
        Source = "reload_empty_60rnd_1",
        MinProgress = 0.85,
        FireASAP = true,
        MagSwapTime = 1.5,
        EventTable = rst_reloadempty60rnd1,
        IKTimeLine = rik_reloadempty1
    },
